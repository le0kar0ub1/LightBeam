#ifndef __BCM283x_MBOX_H__
#define __BCM283x_MBOX_H__

#include <stdint.h>
#include "kernel/def/typedef.h"

#define BCM283x_MBOX_BASE   (0x3f00b880)
...
#define BCM283x_AUX_BASE    (0x3f215000)

#define AUX_IRQ             (0x00)
#define AUX_ENB             (0x04)

/* Mbox call */
void bcm283x_mbox_call(void *);
...
int bcm283x_mbox_hardware_get_mac_address(u8_t *);
int bcm283x_mbox_hardware_get_serial(u64_t *);
int bcm283x_mbox_hardware_get_arm_memory(u32_t *, u32_t *);
int bcm283x_mbox_hardware_get_vc_memory(u32_t *, u32_t *);
