...
#include "target/aarch64/raspi/common/bcm283X/irq.h"
...
struct __attribute__((__packed__, aligned(4))) irq_basic_reg_t
{
...
struct __attribute__((__packed__, aligned(4))) bcm283x_irqControlRegisters_t
{
    ...
    u32_t enableBasicIRQs;                                     // 0x218
    u32_t disableIRQs1;                                        // 0x21C
    u32_t disableIRQs2;                                        // 0x220
    u32_t disableBasicIRQs;                                    // 0x224
};
...
bool bcm283x_interrupt_get_pending_timerIRQ(void);
