...
void generic_vprintf(void (*)(char const *, size_t), struct printfhandlers_t *, char const *, __builtin_va_list);
void generic_printf(void (*)(char const *, size_t), struct printfhandlers_t *, char const *, ...);
